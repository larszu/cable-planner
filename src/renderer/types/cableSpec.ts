...
export const ALL_SIGNAL_STANDARDS: SignalStandard[] = [
  ...
  // #385 / #361 / #369 / #359 / #366 / #360 / #381 — neue Signal-Standards
  'RS-232', 'RS-422', 'RS-485',
  'DMX512', 'RDM', 'Art-Net', 'sACN',
  'CVBS', 'Y/C', 'YPbPr', 'RGBHV',
  'LTC', 'MTC', 'AES3id', 'Tally', 'GPI/GPO', 'HDBaseT',
...
export const cableCatalog: CableSpec[] = [
  ...
  {
    id: 'ltc-bnc',
    name: 'LTC Timecode (BNC/XLR)',
    connectorType: 'BNC',
    compatibleConnectors: ['XLR'],
    standards: ['LTC'],
    maxLengthMeters: 100,
    color: '#64748b',
  ...
  {
    id: 'aes3id-bnc',
    name: 'AES3id (AES/EBU über 75Ω BNC)',
    connectorType: 'BNC',
    standards: ['AES3id'],
    maxLengthMeters: 100,
    color: '#0891b2',
