...
export const en: Dict = {
  ...
  // Lager-Modul — Codes, Maße, Material-Art, Cases
  'inventory.summary2': '{items} items · {units} units · {cases} cases',
  'inventory.tabItems': 'Items',
  'inventory.tabCases': 'Cases ({n})',
  ...
  'inventory.caseDimensions': 'Case outer dimensions (W×H×D · empty weight)',
  'inventory.w': 'W mm',
  'inventory.h': 'H mm',
  'inventory.d': 'D mm',
  'inventory.kg': 'kg',
  'inventory.addCase': 'Case',
  'inventory.newCase': 'New case',
  'inventory.editCase': 'Edit case',
  'inventory.caseName': 'Case name',
  'inventory.casesEmpty': 'No cases yet. Create one and pack items into it.',
  'inventory.caseEmpty': 'Empty.',
  'inventory.caseDeleteTitle': 'Delete case?',
  'inventory.caseDeleteBody': '“{name}” will be deleted (items stay in stock).',
  'inventory.packedWeight': 'packed ~{kg} kg',
  'inventory.pickItem': 'Pick item…',
  'inventory.pack': 'Pack',
  'inventory.unpack': 'Remove from case',
