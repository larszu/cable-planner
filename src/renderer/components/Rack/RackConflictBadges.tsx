...
export const RackConflictBadges = ({
  ...
  return (
    <div className="sticky top-0 z-20 mb-3 border border-red-700/60 bg-red-900/40 px-3 py-2 text-cp-xs text-red-100 backdrop-blur-sm">
      {saveError && (
        <div className="mb-2 flex items-start gap-2">
          ...
          <button
            ...
            className="bg-red-800/80 px-1.5 text-cp-xs hover:bg-red-700"
