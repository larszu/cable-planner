      ...
      {open &&
        createPortal(
          <div
            ...
            id={id}
            role="tooltip"
            className="pointer-events-none fixed z-[var(--cp-z-popover)] max-w-xs rounded-cp-control border border-cp-border bg-cp-surface-2 px-2 py-1 text-cp-xs text-cp-text"
