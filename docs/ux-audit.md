...
| 5 | **a11y baseline**: native dialogs → custom; 15 modals → `ModalShell`; `aria-label` on icon buttons | #32, #33, #41 | 🔨 native dialogs done (#41); icon-button `aria-label` swept (#33/#37/#38/#40); 15 modals → ModalShell pending (#32/#49) |
