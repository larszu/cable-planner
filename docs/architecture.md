...
Stand: v9.0.2 · ~673 TS/TSX-Module · ~198.8k LOC
...
`projectStore.ts` ist intern in **21 Slices** unter `src/renderer/store/slices/`
...
21 Slices unter `store/slices/`. Siehe §3.1.1.
...
(`npm run test:drag`, treibt den Renderer via Playwright). Bei ~198.8k LOC
